...
(Comparison Table) of `collection-content-deep`. Aim for 60-100 words per
profile covering heritage, positioning, unique value, and your store's
...
**Price tier**: {e.g. "$X-Y per unit" — use placeholders, not real prices}

**Notable line or differentiator**: {e.g. the brand's flagship or
allergen-free/clean-formula sub-line, if any}

**Your store's advantage**: {why a buyer should get this brand from you —
catalog breadth, bundling, exclusive line, etc.}

---

## {Brand Name}

(Repeat the structure above for each additional brand you carry. Keep
each profile short and comparable so Section 4's comparison table can
pull consistent dimensions across brands.)
